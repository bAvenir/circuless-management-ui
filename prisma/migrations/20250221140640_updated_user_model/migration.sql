/*
  ...
  - Made the column `familyName` on table `User` required. This step will fail if there are existing NULL values in that column.
...
ALTER COLUMN "familyName" SET NOT NULL,
