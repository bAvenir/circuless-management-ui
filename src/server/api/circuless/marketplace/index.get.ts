...
defineRouteMeta({
    openAPI: {
        tags: ["Circuless Marketplace"],
        description:
            "Retrieve a list of datasets available in the Circuless Marketplace.",
    },
});
            ...
            return await Promise.resolve().then(async () => {
                return [
                    ...
                    },
                    {
                        ...
                        description:
                            "Detailed breakdown of municipal budget allocations, expenditures, and revenue sources for the fiscal year 2024.",
                        tags: [
                            "government",
                            "budget",
                            "finance",
