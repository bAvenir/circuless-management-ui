  ...
  const predefined = {
    user: {
      invited: {
        ...
        error: (e: any) => {
          error('User invitation failed', 'User could not be invited')
        },
      },
      deleted: {
        success: () => success('User deleted', 'User has been deleted successfully'),
        error: (e: any) => {
          error('User deletion failed', 'User could not be deleted')
        },
      },
      synced: {
        success: () => success('User synced', 'User has been synced successfully'),
        error: (e: any) => {
          error('User sync failed', 'User could not be synced')
        },
      }
    },
    organisation: {
      created: {
        ...
        error: (e: any) => {
          error('Organisation creation failed', 'Organisation could not be created')
        },
      },
      updated: {
        success: () => success('Organisation updated', 'Organisation has been updated successfully'),
        error: (e: any) => {
          error('Organisation update failed', 'Organisation could not be updated')
        },
      },
      deleted: {
        success: () => success('Organisation deleted', 'Organisation has been deleted successfully'),
        error: (e: any) => {
          error('Organisation deletion failed', 'Organisation could not be deleted')
        },
      },
      synced: {
        success: () => success('Organisation synced', 'Organisation has been synced successfully'),
        error: (e: any) => {
          error('Organisation sync failed', 'Organisation could not be synced')
        },
      }
    },
    partnership: {
      created: {
        ...
        error: (e: any) =>  {
          error('Partnership creation failed', 'Partnership could not be created')
        },
      },
      updated: {
        success: () => success('Partnership updated', 'Partnership has been updated successfully'),
        error: (e: any) => {
          error('Partnership update failed', 'Partnership could not be updated')
        },
      },
      deleted: {
        success: () => success('Partnership deleted', 'Partnership has been deleted successfully'),
        error: (e: any) => {
          error('Partnership deletion failed', 'Partnership could not be deleted')
        },
      },
    },
    node: {
      created: {
        ...
        error: (e: any) => {
          error('Node creation failed', 'Node could not be created')
        },
      },
      deleted: {
        success: () => success('Node deleted', 'Node has been deleted successfully'),
        error: (e: any) => {
          error('Node deletion failed', 'Node could not be deleted')
        },
      },
    },
  }
